...
class InstrScr(Screen):
    def __init__(self, **kwargs):
        ...
        Ibl1 = Label(text='Введите имя:', halign='right')
        self.in_name = Textimput(multiline=False)
        Ibl1 = Label(text='Введите возраст:', halign='right')
        self.in_age = Textimput(text='7', multiline=False)
        self.btn = Button(text='Начать', size_hint=(0.3, 0.2), pos_hint={'center_x': 0.5})
        self.btn.on_press = self.next
        line1 = Boxlayout(size_hint=(0.8, None), height='30sp')
        line2 = Boxlayout(size_hint=(0.8, None), height='30sp')
        line1.add_widget(Ibl1)
        line1.add_widget(self.in_game)
        line2.add_widget(Ibl1)
...
class PulseScr(Screen):
    def __init__(self, **kwargs):
        ...
        lvl_result = Label(text='Введите результат:',halign='right')
        self.in_result = Textimput(text='0', multiline=False)
...
class PulseScr2(Screen):
    def __init__(self, **kwargs):
        ...
        self.in_result1 = Textimput(text='0', multiline=False)
        line1.add_widget(lbl_result1)
        line2 = Boxlayout(size_hint=(0.8, None), height='30sp')
        lbl_result2 = Textimput(text='0', multiline=False)
